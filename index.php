...
header("Content-type: text/html; charset=utf-8");
    ...
    if(isset($_REQUEST["add"])) {
        $errors = $db->AddmeetingNoDb($connection, $_POST["date"], $_POST["time_start"], $_POST["time_end"], $_POST["comment"]);
    }   
...
<div class="main-calender">
    ...
    <div class="bottom-content">
        <div class="bottom-date-form-pic-div" id="bottom-form-disabled">
            <div class="bottom-img-div"><?php $user->UserPicNoDb(); ?></div>
    ...
    <div>
        <form action="clearsession.php" method="POST">
            <button type="submit">Session Törlés</button>
        </form>
    </div>
